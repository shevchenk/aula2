                            ...
                            <div class="col-lg-6 col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="btn btn-default btn-flat margin btn-xs">
                                        ...
                                        <input type="file" style="display: none;" onchange="masterG.onImagen(event,'#ModalContenido #txt_foto_nombre','#ModalContenido #txt_foto_archivo','#ModalContenido #txt_foto_imagen');">
                                    </label>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="btn btn-default btn-flat margin btn-xs">
                                        ...
                                        <i class="fa fa-file-word-o fa-lg"></i>
                                        <i class="fa fa-file-image-o fa-lg"></i>
                                        <input type="file" style="display: none;" onchange="masterG.onImagen(event,'#ModalContenido #txt_file_nombre','#ModalContenido #txt_file_archivo','#ModalContenido #txt_file_imagen');">
                                    </label>
                                </div>
                            </div>
