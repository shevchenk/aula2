...
var AjaxContenidoV2={
    ...
    ValidaCarga:function(evento,programacion_id,id,curso_id,curso,imagen,boton){
        $("#CursosForm").append("<input type='hidden' value='"+programacion_id+"' name='aux_programacion_id'>");
        $("#CursosForm").append("<input type='hidden' value='"+id+"' name='aux_id'>");
        $("#CursosForm").append("<input type='hidden' value='"+curso_id+"' name='aux_curso_id'>");
        $("#CursosForm").append("<input type='hidden' value='"+curso+"' name='aux_curso'>");
        $("#CursosForm").append("<input type='hidden' value='"+imagen+"' name='aux_imagen'>");
        $("#CursosForm").append("<input type='hidden' value='"+boton+"' name='aux_boton'>");
        var data=$("#CursosForm").serialize().split("txt_").join("").split("slct_").join("");
        $("#CursosForm input[type='hidden']").not('.mant').remove();
