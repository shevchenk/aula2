            ...
            <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    ...
                    <span class="hidden-xs">
                        <?php if(Auth::check()): ?>
                          <?php echo e(session()->get('cargo').' : '.Auth::user()->paterno.' '.Auth::user()->materno.', '.Auth::user()->nombre); ?>
                ...
                <ul class="dropdown-menu">
                    <li class="user-header">
                        ...
                        <p>
                           ...
                           <?php endif; ?>
                          <small>Miembro desde <?php if(Auth::check()): ?> <?php echo e(Auth::user()->created_at); ?> <?php endif; ?></small>
                        </p>
                    </li>
